...
Detalle completo en `.trace/ledger.jsonl`. Integridad verificada con `node scripts/ledger.js verify` → cadena íntegra, 3 entradas (la tercera es una anotación sobre la de fase 1, no un gate nuevo).
